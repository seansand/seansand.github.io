...
function getQuestionText(id) {
    ...
    const questions = {
        ...
        '34': "Costing 62.5 trillion dollars per gram, it is by far the most expensive substance on Earth. It can only be generated by particle accelerators and in theory could be used as fuel for future spacecraft.",
        '44': "The Medes and the Lydians fought a battle on May 28, 585 BCE, the very earliest event that historians know the exact day of due to this astronomical event, which the two sides took as a sign and wrote up a hasty peace treaty.",
